...
const NODES: Array<{
  ...
  { cx: 13, cy: 1.3, sx: 1.4, sy: 1.2, amp: 0.95 },

  { cx: 6.5, cy: 5.0, sx: 1.15, sy: 1.05, amp: 0.65 },
  { cx: 19.5, cy: 5.0, sx: 1.3, sy: 1.15, amp: 0.85 },

  { cx: 3.5, cy: 8.7, sx: 0.95, sy: 0.95, amp: 0.55 },
  { cx: 9.5, cy: 8.7, sx: 0.95, sy: 0.95, amp: 0.55 },
  { cx: 16.5, cy: 8.7, sx: 1.15, sy: 1.05, amp: 0.78 },
  { cx: 22.5, cy: 8.7, sx: 0.95, sy: 0.95, amp: 0.55 },

  { cx: 2.0, cy: 12.5, sx: 0.8, sy: 0.85, amp: 0.45 },
  { cx: 5.0, cy: 12.5, sx: 0.8, sy: 0.85, amp: 0.5 },
  { cx: 8.0, cy: 12.5, sx: 0.8, sy: 0.85, amp: 0.5 },
  { cx: 11.0, cy: 12.5, sx: 0.8, sy: 0.85, amp: 0.5 },
  { cx: 15.0, cy: 12.5, sx: 0.8, sy: 0.85, amp: 0.5 },
  { cx: 18.0, cy: 12.5, sx: 1.25, sy: 1.1, amp: 1.0 },
  { cx: 21.0, cy: 12.5, sx: 0.8, sy: 0.85, amp: 0.5 },
  { cx: 24.0, cy: 12.5, sx: 0.8, sy: 0.85, amp: 0.45 },
];
